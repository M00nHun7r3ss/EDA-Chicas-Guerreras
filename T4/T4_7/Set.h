...
public:
    ...
    */
    ...
    {
        //bandera para saber si esta incluido o no
        bool included = true;
        //Recorremos ambos sets, para ver cuales coinciden y cuales no
        int i = 0, j = 0;

        while (i < nelems && j < other.nelems && included)
        {
            //Si coinciden, es que esta incluido
            ...
            //This esta mas avanzado que other
            else if (array[i] > other.array[j])
            {
                //Avanzamos solo other, para ir buscando
                j++;
            }
            //Other esta mas avanzado que this
            else
            {
                //Esto significa que no se ha encontrado el elemento en this
                return false;
            }
        }

        //Ahora bien, si hemos llegado al fin de other,
        //pero no al fin de this, no estara incluido
        //Pero si this ha llegado al final, estara incluido
        return  (i == nelems);
    }
