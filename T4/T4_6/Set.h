...
public:
    ...
    //METODOS PEDIDOS
    //Consultar elemento maximo
    /*Complejidad:
        O(1) porque devolvemos directamente el elemento
    */
    int getMax() const
    {
	...
	*/
    ...
    //Quitar elemento maximo
	/*Complejidad:
        O(1) porque eliminamos directamente el elemento
    */
    void removeMax()
    {
        //remove(getMax());
        //Disminuyendo el numero de elementos totales,
        //se obvia el ultimo
        --nelems;
    }

    //Quitar elemento minimo
	/*Complejidad:
		O(n) porque, aunque eliminamos directamente el elemento,
        realizamos un desplazamiento de todos los elementos del vector
    */
    void removeMin()
    {
        //remove(getMin());
        //Mueve todo a la izquierda, para "tapar" el elemento minimo
        shiftLeftFrom(0);
        //Disminuye el numero de elementos totales,
        --nelems;
    }
